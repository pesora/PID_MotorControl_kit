...
#include "sysinc.h"
  ...
  /**
  * @brief MPU6050 register write data
...
void MPU6050_ByteWrite(uint8_t REG_Address,uint8_t REG_data)
{
  ...
  /**
  * @brief MPU6050 register read data
  * @param[in] REG_Address register address value: refer to the register address in the header file
  * @return read data
  */
...
/**
  * @brief MPU6050 device detection
  * @return Return value: 1, detection successful 0, detection failed
  */
...
u8 MPU6050_Check(void)
{
  ...
  /**
  * @brief MPU6050 static difference self-test function
  * @param[in] ag MPU6050 data structure pointer
  */
...
void MPU6050_GetData(ACGY *ag)
{
  ...
  /**
  * @brief MPU6050 acceleration data to calculate the angle
  * @param[in] ag MPU6050 data structure pointer
  */
void MPU6050_Acc_Angle(ACGY *ag)
{
  ...
  /**
  * @brief MPU6050 gyroscope calculates angular velocity
  * @param[in] ag MPU6050 data structure pointer
  */
