/**
   ...
   * @version V1.0
   * @date 2016.9.10
   * @note This program is the underlying programming of ADC1 in ARM (attached to the secondary encapsulation of the official underlying library)
   *************************************************** ****************************
   */
...
/* ADC rule channel port definition */
